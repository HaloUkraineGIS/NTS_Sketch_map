import{jj as A,c5 as M,dV as at,jR as Ne,jm as le,ng as ee,r8 as rt,pW as ce,r9 as st,jl as lt,jn as ct,jp as ft,jo as ut,ji as k,oO as dt,fP as _t,ic as vt,ra as ht,ak as H,bJ as ge,rb as mt,d$ as oe,nw as Fe,rc as pt,rd as gt,re as yt,rf as xt,ax as ve,ef as St,eh as Tt,cb as It,rg as N,rh as Be,jr as ye,cK as bt,cJ as Et,ri as xe,s as Ue,jT as Ot,gL as Se,x as At,rj as Pt}from"./index-DoBJAHic.js";import{$ as Mt,d as Te,f as Ct,g as Ye,s as z,t as Lt,n as q,e as X,h as Ge}from"./Utils-BomYqyEb.js";import{e as zt,a as te}from"./ProgramTemplate-BdVUobmi.js";import{h as $}from"./VertexArrayObject-Zjz9vSe3.js";import{n as Dt}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./VertexBuffer-C6olF9hy.js";import{n as Rt}from"./vec3f32-WCVSSNPR.js";import{e as He,n as Vt}from"./Container-DxS9n-yP.js";import{n as wt}from"./memoryEstimations-BSoBNvfQ.js";import{o as fe}from"./BufferObject-Domg33ef.js";import{e as Ie}from"./config-BOD8--da.js";import{e as Nt}from"./earcut-D9gy186-.js";import{t as Ft,X as Bt}from"./featureConversionUtils-CVRcCFIm.js";import{e as be}from"./OptimizedFeature-_EOnxddE.js";function ke(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return ke()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function Xe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),Ht=Ze(),kt=je(),$t=Ke(),Wt=Xe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:Ht,UNIT_Y:kt,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:ke,fromValues:B,ones:We,unitW:Xe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
...
//# sourceMappingURL=WGLContainer-B3GwPwTU.js.map
